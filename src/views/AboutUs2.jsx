...
export function AboutUs2({ refAboutUs, refAboutUsTitle, refAboutUsParagraph }) {
  const { language } = useContext(LanguageContext);
  return (
    <>
      <section ref={refAboutUs} className="aboutUs2-container">
        <h3 ref={refAboutUsTitle} className="section-title">
          {language === "spanish" ? "Sobre Nosotros" : "About Us"}
        </h3>

        <div ref={refAboutUsParagraph} className="aboutUs2-center-container">
          <article>
            <h4>
