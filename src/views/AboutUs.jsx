        ...
        <article className="aboutUs-intro">
          <p>
            {language === "spanish" ? (
              ...
              <>
                We are a team of developers committed to excellence
                <br />
                in every line of code.
                <br />
                <br />
                We stand out for our ability to understand the needs
                <br />
                specific to each project and quickly adapt to the changes.
                <br />
                <br />
                We believe in open communication and close collaboration with
                our clients at every stage of the development process. We are
            ...
            {language === "spanish" ? (
              <>
                <p>
                  ...
                  <br />
                  Fundador de ZMDevs, líder apasionado y visionario en el
                  <br />
            ...
            {language === "spanish" ? (
              <>
                <p>
                  ...
                  <br />
                  CTO de ZMDevs, desarrollador y gestor de proyectos
                  <br />
              ...
              <>
                <p>
                  Civil Engineer from the National Technological University.
                  <br />
                  CTO of ZMDevs, developer and project manager
                  <br />
